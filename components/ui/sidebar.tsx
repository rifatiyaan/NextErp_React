    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                "data-[active=true]:bg-primary/10 data-[active=true]:dark:bg-primary/20 data-[active=true]:text-primary data-[active=true]:dark:text-foreground data-[active=true]:font-medium",
                size === "sm" && "text-xs",
                size === "md" && "text-sm",
                "group-data-[collapsible=icon]:hidden",
                className
